...
[![Build Status](https://travis-ci.org/logolevel/api.svg?branch=master)](https://travis-ci.org/logolevel/api)
...
6. If you did everything correct, https://logolevel.github.io/api/ will lead to your new docs
...
- Documentation(ReDoc): https://logolevel.github.io/api/
- SwaggerUI: https://logolevel.github.io/api/swagger-ui/
- Look full spec:
    + JSON https://logolevel.github.io/api/swagger.json
    + YAML https://logolevel.github.io/api/swagger.yaml
- Preview spec version for branch `[branch]`: https://logolevel.github.io/api/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://logolevel.github.io/api/ with url from the message: `Server started <url>`
